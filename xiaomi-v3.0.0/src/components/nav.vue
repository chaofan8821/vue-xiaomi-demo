<template>
  <div id="cart">
  	<div :style='{opacity:showOrHide?"0":"1"}' class="cart-box" ref='cart_box'>
    ...
    <div class="cart-list">
      <div v-if='showOrHide' class="meng" @click='showOrHide=!showOrHide'></div>
...
export default {
  ...
  methods: {
      ...
      // 移动选中项位置 scrollTo方法在 Android 不兼容
